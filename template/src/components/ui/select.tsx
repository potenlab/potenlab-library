  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownIcon className="size-4 text-[#A0AEC0] transition-[transform,color] duration-300 ease-in-out [[data-state=open]>&]:rotate-180 [[data-state=open]>&]:text-[#509594] [.focus>&]:text-[#509594] [:focus>&]:text-[#509594]" />
